...
5. Task.py парсит xml по его (патчам) собирая необходимую информацию об уязвимости - Вывод в файле "filterText.txt"
6. parserOVAL.py я постарался сделать программу, которая будет парсить <objects> и выводить необходимую информацию - Вывод в файле "parsed_objects.txt"
