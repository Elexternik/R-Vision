...
with open('filterText.txt', 'w') as file:
    for elem in root.iter('{http://oval.mitre.org/XMLSchema/oval-definitions-5}definition'):
        ...
        severity = elem.find('{http://oval.mitre.org/XMLSchema/oval-definitions-5}metadata/{http://oval.mitre.org/XMLSchema/oval-definitions-5}advisory/{http://oval.mitre.org/XMLSchema/oval-definitions-5}severity').text
        separator = "----------------------------------------------------------------------------------------------"
